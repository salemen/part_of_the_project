...
<?= GridView::widget([
    ...
    'panel'=>[
        'before'=>$this->render('_search-archive', ['model'=>$searchModel]),
        'heading'=>false
    ],
    'responsive'=>false,
    'columns'=>[
...
//            'header'=> 'Поликлиника',
//            'contentOptions'=>['class'=>'kv-align-middle'],
//            'headerOptions'=>['class'=>'kv-align-center kv-align-middle', 'style'=>'width:200px;'],
//            'value'=>function ($model) {
