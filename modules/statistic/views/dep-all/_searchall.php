...
<div class="employee-degree-index">
    ...
    <form method="get" id="search" action="<?= Url::to(['dep-all/index']) ?>">
        ...
        <div class="col-md-12">
            <center>
                <input type="submit" class="btn btn-success" name="all" value="Поиск всех">
...
//        ],
        [
            'attribute'=>'',
            'header'=>'Агентское вознаграждение',
            'headerOptions'=>['class'=>'kv-align-center kv-align-middle', 'width'=>'150px'],
            'value'=>function($model) {
                if($model->payment->orderSumAmount){
                   return round($model->payment->orderSumAmount/100*10, 2);
                }
            }
        ],
