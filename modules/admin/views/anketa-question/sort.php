...
$this->params['breadcrumbs'][] = ['label'=>'Вопросы', 'url'=>['index', 'anketa_id'=>$anketa_id]];
...
<?= GridView::widget([
    ...
    'panel'=>[
        'before'=>Html::button('Сохранить', ['id'=>'save-sort', 'class'=>'btn btn-success', 'data-url'=>Url::to(['sort', 'anketa_id'=>$anketa_id]), 'style'=>'margin-right: 3px;']) . Html::a('Отмена', ['index', 'anketa_id'=>$anketa_id], ['class'=>'btn btn-danger'])
    ],
