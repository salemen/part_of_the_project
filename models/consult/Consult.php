...
class Consult extends ActiveRecord
{   
    ...
    {
        return [
            [['comment'], 'required', 'on'=>'cancel-consult'],
            [['dep_id'], 'required', 'on'=>'choose-department'],
    ...
    public function getEmposition()
    {
        return $this->hasOne(EmployeePosition::className(), ['employee_id'=>'employee_id']);
    }
    ...
    {
        return $this->hasOne(Cardio::className(), ['employee_id'=>'employee_id']);
    }
