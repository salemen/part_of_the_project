...
class UserHeight extends ActiveRecord
{      
    public $delete;
    
    public static function tableName()
    {
        return 'user_p_height';
    }
    ...
    {
        return [
            [['user_id', 'height', 'created_at'], 'required'],
            [['height'], 'integer'],
    ...
    {
        return Statistic::getStatistic(self::find(), ['height'], $param_name, null, $is_detail);
    }
}